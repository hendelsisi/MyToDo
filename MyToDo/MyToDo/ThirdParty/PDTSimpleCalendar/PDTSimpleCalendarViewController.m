...
- (void)viewDidLoad
{
    ...
    if (_previouseSelectedDateFromUserfromThePreviousScene != nil) {
        self.selectedDate = _previouseSelectedDateFromUserfromThePreviousScene;
        [self scrollToDate:_selectedDate animated:YES];
    }
